...
${OBJECTDIR}/src/classes/InputHandler.o: src/classes/InputHandler.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/classes/InputHandler.o src/classes/InputHandler.cpp

${OBJECTDIR}/src/classes/cograph.o: src/classes/cograph.cpp
	${MKDIR} -p ${OBJECTDIR}/src/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/classes/cograph.o src/classes/cograph.cpp

${OBJECTDIR}/src/classes/cotree.o: src/classes/cotree.cpp
	${MKDIR} -p ${OBJECTDIR}/src/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/classes/cotree.o src/classes/cotree.cpp

${OBJECTDIR}/src/classes/edge.o: src/classes/edge.cpp
	${MKDIR} -p ${OBJECTDIR}/src/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/classes/edge.o src/classes/edge.cpp
...
${OBJECTDIR}/src/classes/reader.o: src/classes/reader.cpp
	${MKDIR} -p ${OBJECTDIR}/src/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/classes/reader.o src/classes/reader.cpp

${OBJECTDIR}/src/classes/vertice.o: src/classes/vertice.cpp
	${MKDIR} -p ${OBJECTDIR}/src/classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/classes/vertice.o src/classes/vertice.cpp
